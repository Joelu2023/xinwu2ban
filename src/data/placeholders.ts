export const previewMembers = [
  {
    ...
    industry: '制造业',
    keywords: ['利他经营', '组织升级'],
    avatar: '/images/members/member-01.png',
  },
  {
    name: '同学姓名',
    company: '示例科技股份公司',
    industry: '科技服务',
    keywords: ['团队协同', '精益经营'],
    avatar: '/images/members/member-02.png',
  },
  {
    name: '同学姓名',
    company: '示例商贸集团',
    industry: '零售流通',
    keywords: ['企业文化', '数字化转型'],
    avatar: '/images/members/member-03.png',
  },
  {
    name: '同学姓名',
    company: '示例实业公司',
    industry: '装备制造',
    keywords: ['接班成长', '长期主义'],
    avatar: '/images/members/member-04.png',
  },
] as const
...
export const previewActivities = [
  {
    ...
    tag: '月度节奏',
    cover: '/images/activities/activities-course-01.png',
  },
  {
    title: '企业参访',
    desc: '走进同学企业，看见真实经营现场与管理实践。',
    tag: '深度连接',
    cover: '/images/activities/activities-visit-01.png',
  },
  {
    title: '读书会',
    desc: '共读经典与塾内资料，形成小组讨论与分享输出。',
    tag: '共学共修',
    cover: '/images/activities/activities-reading-01.png',
  },
  {
    title: '小组共学',
    desc: '围绕主题任务协作推进，把学习转化为行动课题。',
    tag: '实践触发',
    cover: '/images/activities/activities-group-01.png',
  },
] as const
...
export const previewCases = [
  {
    ...
    cover: '/images/cases/cases-business-01.png',
  },
  {
    title: '组织管理案例',
    category: '组织管理',
    summary: '打通部门协同与目标共识，让团队真正朝一个方向用力。',
    cover: '/images/cases/cases-org-01.png',
  },
  {
    title: '个人成长案例',
    category: '个人成长',
    summary: '经营者心智升级与领导力修炼，带动组织氛围积极变化。',
    cover: '/images/cases/cases-personal-01.png',
  },
  {
    title: '利他经营案例',
    category: '利他经营',
    summary: '以客户与员工为起点重构价值，形成长期信任关系。',
    cover: '/images/cases/cases-altruism-01.png',
  },
] as const
